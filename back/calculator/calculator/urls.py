...
urlpatterns = [
    ...
    path('api/products/', BrandList.as_view(), name='product-list'),
    path('api/products/<int:pk>/', BrandDetail.as_view(), name='product-detail'),
    path('api/models-by-brand/', ModelsByBrandView.as_view(), name='models-by-brand'),
    path('api/modification-by-model/', ModificationByModelView.as_view(), name='modification-by-model'),
    path('api/brands/', BrandList.as_view(), name='brand-list'),
    path('api/regions/', RegionList.as_view(), name='region-list'),
    path('api/cost_of_carship/', CountSumView.as_view(), name='cost-of-carship'),
    path('api/requested_car/', RequestedCarView.as_view(), name='requested-car'),
    path('api/statistic/', CarRequestStatisticView.as_view(), name='statistic'),
